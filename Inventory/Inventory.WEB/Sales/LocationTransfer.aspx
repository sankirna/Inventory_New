<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory.Master" AutoEventWireup="true" CodeBehind="LocationTransfer.aspx.cs" Inherits="Inventory.Web.Sales.LocationTransfer" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

    <h1 class="title">Transfer the Location of Item</h1>
    ...
    <%--<table class="formGrid" width="100%">
        <tr>
            <td>
                <asp:Label Text="Caton Barcode" runat="server" />
            </td>
            <td>
                <asp:TextBox runat="server" ID="txtCartonBarcode" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label Text="Item Barcode" runat="server" />
            </td>
            <td>
                <asp:TextBox runat="server" ID="txtItemBarcode" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label Text="New Location" runat="server" />
            </td>
            <td>
                <asp:TextBox runat="server" ID="txtNewLocation" />
            </td>
        </tr>
    </table>--%>
