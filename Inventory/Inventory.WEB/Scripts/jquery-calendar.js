...
var popUpCal = {
    ...
    selectDate: function (Input) {
        ...
        if (Input[0].id == "MainContent_txtVesselETA") {

            //alert($("#MainContent_hdfvalue").val());
            var datepicker = $("#" + Input[0].id).val();
            var myDate = datepicker;
            myDate = myDate.split("/");
            var newDate = myDate[1] + "/" + myDate[0] + "/" + myDate[2].split(" ")[0];


            from = datepicker.split("/");
            f = new Date(datepicker.split("/")[2].split(" ")[0], datepicker.split("/")[1], datepicker.split("/")[0], datepicker.split("/")[2].split(" ")[1].split(":")[0], datepicker.split("/")[2].split(" ")[1].split(":")[1]);
            var joindate = new Date(f);
            var numofdaystoadd = parseInt($("#MainContent_hdfvalue").val());
            joindate.setDate(joindate.getDate() + numofdaystoadd);
            //joindate.setHours(joindate.getHours() - (parseInt(numofdaystoadd)));
            var dd = joindate.getDate();
            var MM = joindate.getMonth();//january is calculated as 0
            var yyyy = joindate.getFullYear();
            var hh = joindate.getHours();
            var hh1;
            if (hh > 12) {
                hh1 = hh - 12;
            }
            ...
            var mm = joindate.getMinutes();
            var formate = "AM";
            if (hh > 11)
                formate = "PM";
            //var fin = this.formatDate(dd, MM, yyyy, hh, mm);
            //$("#MainContent_txtRequiredDate").val(fin);
            $("#MainContent_txtRequiredDate").val(dd + "/" + (MM >= 10 ? MM : "0" + MM) + "/" + yyyy + " " + hh1 + ":" + (mm >= 10 ? mm : "0" + mm) + " " + datepicker.split("/")[2].split(" ")[2]);

        }

        if (Input[0].id == "MainContent_txtClosingTime") {
            ...
            f = new Date(datepicker.split("/")[2].split(" ")[0], datepicker.split("/")[1], datepicker.split("/")[0], datepicker.split("/")[2].split(" ")[1].split(":")[0], datepicker.split("/")[2].split(" ")[1].split(":")[1]);
            var joindate = new Date(f);
            var numofdaystoadd = parseInt($("#MainContent_hdfminushours").val());
            if (datepicker.split("/")[2].split(" ")[2] == "PM")
                joindate.setHours((parseInt(joindate.getHours()) + 12) - parseInt(numofdaystoadd));
            else
                joindate.setHours((parseInt(joindate.getHours()) ) - parseInt(numofdaystoadd));
            //joindate.setHours(joindate.getHours() - (parseInt(numofdaystoadd)));
            var dd = joindate.getDate();
            var MM = joindate.getMonth();//january is calculated as 0
            var yyyy = joindate.getFullYear();
            ...
            //var fin = this.formatDate(dd, MM, yyyy, hh, mm);
            //$("#MainContent_txtRequiredDate").val(fin);
            $("#MainContent_txtRequiredDate").val(dd + "/" + (MM >= 10 ? MM : "0" + MM) + "/" + yyyy + " " + hh1 + ":" + (mm >= 10 ? mm : "0" + mm) + " " + formate);
            //debugger;
            ////alert($("#MainContent_hdfvalue").val());
            //var datepicker = $("#" + Input[0].id).val();
            //var joindate = new Date(new Date(datepicker).toString("dd/MM/yyyy hh:mmtt"));
            //var numofdaystoadd = parseInt($("#MainContent_hdfminushours").val());
            //joindate.setDate(joindate.getHours() - numofdaystoadd);
            //var dd = joindate.getDate();
            //var MM = joindate.getMonth();
            //var yyyy = joindate.getYear();
            //var hh = joindate.getHours();
            //var mm = joindate.getMinutes();
            //var formate = "AM";
            //if (hh > 11)
            //    formate = "PM";
            //$("#MainContent_txtRequiredDate")[0].value = dd + "/" + MM + "/" + yyyy + " " + hh + ":" + mm + "" + formate;
        }
    },
